...
public class ClassicBoardCreator implements BoardCreator{
    @Override
    public Board create() {
        List<Tile> generatedTiles = generateTiles(8,8);
        insertClassicPieces(generatedTiles);
        return new Board(generatedTiles);
    }
    private void insertClassicPieces(List<Tile> generatedTiles) {
